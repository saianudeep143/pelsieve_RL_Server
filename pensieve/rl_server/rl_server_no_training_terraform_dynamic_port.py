    ...
    class Request_Handler(BaseHTTPRequestHandler):
        ...
        def do_POST(self):
            ...
            if ( 'pastThroughput' in post_data ):
                ...
                print 'Predicted Bit_rate : ' + str(bit_rate)
...
def run(server_class=HTTPServer, port=0, log_file_path=LOG_FILE):
    ...
    with tf.Session() as sess, open(log_file_path, 'wb') as log_file:
        ...
        server_address = ('172.31.29.38', port)
